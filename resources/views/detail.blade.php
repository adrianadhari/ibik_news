                ...
                <div class="col-lg-8">
                    ...
                    <div class="content-post">
                        ...
                        <div class="position-relative rounded overflow-hidden mb-3">
                            <img src="{{ Storage::url($post->thumbnail) }}" class="img-zoomin img-fluid rounded w-100" alt="">
                        ...
                        <div class="d-flex">
                            <p class="text-dark link-hover me-3"><i class="fa fa-eye"></i> {{ $post->viewed }} Views</p>
                            <p class="text-dark link-hover me-3"><i class="fa fa-comment-dots"></i> 2 Comment</p>
                        </div>
                        <div>
                            {!! $post->content !!}
                        </div>
                    ...
                    <div class="bg-light rounded p-4 my-4">
                        <h4 class="mb-0 font-bold mb-4">2 Comment</h4>

                        <div class="d-flex flex-column gap-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="comments d-flex gap-3">
                                    <div>
                                        <img src="img/person-1.jpg" alt="User" class="rounded-circle" width="50px">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="user-comment mb-0 fw-bold">Sasuke</p>
                                        <p class="time-comment mb-0">2 hours ago</p>
                                        <p class="content-comment mb-0 fw-medium lh-base text-black">
                                            Kereeen kontennyaaa!!!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="comments d-flex gap-3">
                                    <div>
                                        <img src="img/person-2.jpg" alt="User" class="rounded-circle" width="50px">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="user-comment mb-0 fw-bold">Sakura</p>
                                        <p class="time-comment mb-0">1 hours ago</p>
                                        <p class="content-comment mb-0 fw-medium lh-base text-black">
                                            Untuk penegakan Hukum di Indonesia ini tlg ditertibkan, karna sdh terlalu
                                            berantakan, semrawut, amburadul, ruwet, suram. Penegak hukum mulai dari
                                            polisi,
                                            jaksa sampai hakim sdh sulit untuk dipercaya integritas dan kredibilitasnya.
                                            contohnya kasus Hakim Pembebas Ronald Tannur.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Comments Input Start -->
                    <div class="bg-light rounded p-4 my-4">
                        <h4 class="mb-4">Leave A Comment</h4>
                        <form action="#">
                            <div class="row g-4">
                                <div class="col-12">
                                    <textarea class="form-control" name="comment" id="" cols="30" rows="7"
                                        placeholder="Write Your Comment Here"></textarea>
                                </div>
                                <div class="col-12">
                                    <!-- <button class="w-100 btn btn-primary py-3" type="submit">Submit</button> -->
                                    <a href="#" class="btn fw-medium shadow-sm" style="background-color: white"> Sign In
                                        First
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-5">
                                                <div class="overflow-hidden rounded">
                                                    <img src="img/news-2.jpg" class="img-zoomin img-fluid rounded w-100"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="col-7">
                                                <div class="features-content d-flex flex-column">
                                                    <a href="detail-page.html" class="h6">Get the best speak market,
                                                        news.</a>
                        ...
                        <div class="d-flex flex-column mb-4">
                            ...
                            <a href="detail-page.html">
                                <div class="d-flex align-items-center">
                                    <div class=" border border-2 border-primary overflow-hidden" style="width: 140px;">
